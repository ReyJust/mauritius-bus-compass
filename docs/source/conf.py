...
# mbc_data_processing documentation build
...
from mbc_data_processing import __version__ as release

# -- Project information -----------------------------------------------------

project = "mbc_data_processing"
author = "Kedro"
...
htmlhelp_basename = "mbc_data_processingdoc"
...
latex_documents = [
    (
        master_doc,
        "mbc_data_processing.tex",
        "mbc_data_processing Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "mbc_data_processing",
        "Project mbc_data_processing codebase.",
        "Data-Science",
    )
]
